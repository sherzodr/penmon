...
class Test(unittest.TestCase):
    ...
    def test_actual_vapour_pressure_dew(self):
        ...
        self.assertEqual(day.actual_vapour_pressure(), 1.938, "Actual vapour pressure with no psychrometric data")
    ...
    def test_actual_vapour_pressure_humidity_max_temp_min(self):
        ...
        actual_vp = day.actual_vapour_pressure()
        self.assertEqual(actual_vp, 1.692, "Actual vapour pressure with only humidity_max and temp_min")
    ...
    def test_actual_vapour_pressure_humidity_mean(self):
        ...
        actual_vp = day.actual_vapour_pressure()
        self.assertEqual(actual_vp, 1.779, "Actual vapour pressure with only humidity_mean, temp_min and temp_max")
