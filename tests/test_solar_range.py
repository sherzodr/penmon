...
class Test(unittest.TestCase):
    ...
    def test_solar_radiation_range(self):
        ...
        try:
            ...
            self.assertTrue(False, "Out of range ValueError caught: " + str(e))
        else: 
            self.assertTrue(True, "Out of range ValueError NOT caught")
    ...
    def test_no_solar_range_test(self):
        ...
        self.assertTrue(pm.eto.CHECK_RADIATION_RANGE, "CHECK_RADIATION_RANGE defaults to True")

        pm.eto.CHECK_RADIATION_RANGE = False

        self.assertTrue(pm.eto.CHECK_RADIATION_RANGE == False, "CHECK_RADIATION_RANGE defaults to True")
    ...
    def test_check_sunshine_hours_range_error_ignore(self):
        pm.eto.CHECK_SUNSHINE_HOURS_RANGE = False
        ...
        pm.eto.CHECK_SUNSHINE_HOURS_RANGE = True
